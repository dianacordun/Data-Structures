...
{
    if (K <= 0)// pentru cazul in care primiste numar negativ
        return { nullptr, a };
    if (a == nullptr)
            ...
            double p_insert = 0.6)
{
    ...
    cout<< (timp_final - timp_inceput).count() / 1e9<<"\n\n";}
            ...
            else { auto timp_inc = chrono::high_resolution_clock::now();
...
int main()
{
    /*for (int i = 0; i <= 1; i++) //acest test ofera posibilitatea sa se observa faptul ca putem adauga numere mari de tipul: 972788155321194609 sau -949314519530419175
    {
      cout << "Test #" << i << ": ";
       GenerateRandomTest(20000);
    }*/
